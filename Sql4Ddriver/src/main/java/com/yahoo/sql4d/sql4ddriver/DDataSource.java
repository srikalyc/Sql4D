...
//         }
        ...
        String n = "SELECT LONG_SUM(count) AS count, content_uuid AS content_uuid, uri AS content_click_url, content_publish_time AS content_published_date, is_deleted AS content_deleted, content_thumbnail_url AS content_thumb, content_type AS content_type FROM cmeta_v5 WHERE interval BETWEEN 2012-05-30T00:00:00.000-04:00 AND 2014-05-31T23:00:00.000-04:00 AND provider_id='wall_street_journal_733' AND content_type='cavideo' BREAK BY 'all' GROUP BY content_uuid,content_click_url,content_published_date,content_deleted,content_thumb,content_type ORDER BY count LIMIT 5;";
        String nj = "SELECT content_uuid AS content_uuid, LONG_SUM(content_views) AS content_views, LONG_SUM(shares) AS shares, LONG_SUM(headline_views) AS headline_views FROM content_agg_hourly_v5 WHERE interval BETWEEN 2014-04-30T00:00:00.000-04:00 AND 2014-05-31T23:00:00.000-04:00 AND provider_id='wall_street_journal_733' AND content_type='cavideo' BREAK BY 'all' GROUP BY content_uuid ORDER BY content_views LIMIT 5 JOIN (SELECT LONG_SUM(count) AS count, content_uuid AS content_uuid, uri AS content_click_url, content_publish_time AS content_published_date, is_deleted AS content_deleted, content_thumbnail_url AS content_thumb, content_type AS content_type FROM cmeta_v5 WHERE interval BETWEEN 2012-05-30T00:00:00.000-04:00 AND 2014-05-31T23:00:00.000-04:00 AND provider_id='wall_street_journal_733' AND content_type='cavideo' BREAK BY 'all' GROUP BY content_uuid,content_click_url,content_published_date,content_deleted,content_thumb,content_type) ON (content_uuid);";
        DDataSource driver = new DDataSource("bk1.qa.analytics.media.gq1.yahoo.com", 4080, "co2.qa.analytics.media.gq1.yahoo.com", 8082, null, 3128);
         Either<String,Either<Joiner4All,Mapper4All>> result = driver.query(n, true, "sql");
